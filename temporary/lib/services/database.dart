...
class DatabaseService {
  ...
  Future newRunningLog(String sport, Timestamp date, int heartrate, String runType, int calories, String effortLevel, int time, int distance) async {
    return await usersCollection.doc(uid).set({
      'sport': sport,
      'date': date,
      'heartrate': heartrate,
  ...
  Future newSwimmingLog(String sport, Timestamp date, int splitTime, int setTime, int warmupDistance, int workoutDistance, int warmpdownDistance, int repeats, String drylands) async {
    return await usersCollection.doc(uid).set({
      'sport': sport,
      'date': date,
      'splitTime': splitTime,
